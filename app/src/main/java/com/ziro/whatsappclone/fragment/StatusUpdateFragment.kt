...
import com.ziro.whatsappclone.util.*
...
class StatusUpdateFragment : Fragment() {
    ...
    fun onUpdate() {
        ...
        firebaseDB.collection(DATA_USERS)
            ...
            .addOnSuccessListener {
                progress_layout.visibility = View.GONE
                Toast.makeText(activity, "Status updates", Toast.LENGTH_SHORT).show()

            }

            .addOnFailureListener {
                progress_layout.visibility = View.GONE
                Toast.makeText(activity, "Status updated failed", Toast.LENGTH_SHORT).show()
